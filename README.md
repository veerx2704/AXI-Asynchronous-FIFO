...
This repository is a direct extension of the previously implemented [Asynchronous FIFO repository](https://github.com/veerx2704/async_fifo) and is currently a WIP. 
...
Status of project - 
 - Design : First draft of AXI interface ready
 - Verification : UVM Testbench development in progress