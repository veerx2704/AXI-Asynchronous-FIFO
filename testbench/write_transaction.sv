...
constraint valid_aw {awvalid == 1'b1;}
constraint valid_w {wvalid == 1'b1;}
constraint ready_when {bready == 1;}
  constraint address {awaddr.size() == 1; awaddr[0] inside {[0:16'hffff]};}
